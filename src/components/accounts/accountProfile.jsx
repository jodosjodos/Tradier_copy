  ...
  return (
    <div>
        {manageAccountData.map((account, index) => (
            ...
            <div className=' py-5 px-10 mt-1 bg-gray-200 flex'>
              <label className='font-medium'>Descriptive name</label>
              <input type="text" value={account.name} name='accountName' className='ml-12 px-4 py-2 outline-none focus:outline-blue-50 rounded-md' />
            </div>
            <div className='py-5 px-24 mt-1 font-medium bg-gray-200'>
              <p>My suffix</p>
            </div>
            ...
            <div className='flex py-5 px-24 mt-1 font-medium bg-gray-200'>
